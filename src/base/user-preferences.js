...
class UserPreferences extends EventEmitter {
  ...
  set(key, value) {
    ...
    // Checking is this key described in the preferences list (i.e., reject any keys which are not described on top of this file)
    if (typeof preferences[key] === 'undefined')
    ...
    this.preferencesFileBuffer[key] = (preferences[key].type === Boolean && typeof value === 'string') ? (value === 'true') : preferences[key].type(value);
