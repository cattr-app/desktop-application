...
module.exports = {
  ...
  async screenshotNotification(screenshot, interval) {
    ...
    if (process.platform === 'darwin' && Notification.isSupported())
      return this.screenshotSystemNotification(screenshot, interval);
    ...
    notification.loadURL(`file://${config.apppath}/renderer/screen-notie.html`);
    ...
    notification.webContents.on('dom-ready', async () => {
      ...
      notificationRouter.emit('notification/screenshot', { screenshot, interval });
