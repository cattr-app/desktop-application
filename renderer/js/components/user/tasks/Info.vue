<template>
  <el-container class="task-info-container">
    ...
    <el-divider style="margin: 0;" class="section-divider"></el-divider>
    ...
    <div class="task-controls">
      <el-button type="primary" @click="back">{{$t('Back to tasks')}}</el-button>
      <el-button type="secondary" v-if="task.externalUrl !== null" @click="openInBrowser">
        {{ $t('Open in browser')}}
      </el-button>
      <el-button class="task-toggler" @click="track" :type="active ? 'success' : 'primary'" :plain="!active">
        {{ trackedTime }}
      </el-button>
    </div>
  </el-container>
